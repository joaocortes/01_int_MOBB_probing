...
public:
	 ...
	 */
	void generateCoverCuts(BranchingDecisions* bd, MathematicalModel* lp, int iteration);
	 ...
	 * \param lp, MathemeticalModel.
	 */
	void generateLCI(BranchingDecisions* bd, MathematicalModel* lp, int iteration);
};
